...
<title>Wercker New Oracle Public Cloud Demo</title>
...
<body>
    ...
    <div class="container">
      ...
      <div class="blueBannerHeading">
        <h1 class="blueBannerTitleWithSubtitle">
          <a style="color: #ffffff">Kubernetes</a>&nbsp;+
  ...
  <div class="container serviceContainer" style="margin-top: 150px;">
    <div class="overviewLayout">
      <div>
              <br>SpringBoot  application demo by George Xiang 0402 .  Current server time: <%= new java.util.Date() %> <br>
              <br>
              <p>
